...
public class PaymentsProjectionsService
{
    private readonly IOffsetsRepository _offsetsRepository;
    private readonly IEventProcessor[] _eventProcessors;
    private readonly EventStoreClient _client;
    private readonly ILogger<PaymentsProjectionsService> _logger;

    private const string Id = "PaymentsProjectionsService";

    public PaymentsProjectionsService(
        IOffsetsRepository offsetsRepository,
        IEnumerable<IEventProcessor> eventProcessors,
        EventStoreClient client,
        ILogger<PaymentsProjectionsService> logger)
    {
